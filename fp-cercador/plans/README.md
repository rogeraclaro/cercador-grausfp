...
| 059 | FPO (SOC Catalunya): `soc_scraper.py` (browse Algolia dels 3 índexs), pipeline no-fatal, `/api/fpo/*`, historial i avís admin | P3 | M | — | TODO — spec `docs/superpowers/specs/2026-09-06-fpo-soc-catalunya-design.md` |
