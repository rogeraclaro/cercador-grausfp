...
| 062 | FPO extern: scrapers de PIMEC (endpoint AJAX, paginat fins a pàgina buida, àrea per escaneig) i Foment (sitemap sense fragments, edicions), `ext_cursos.json`, bloc no fatal al pipeline amb snapshot segur per font | P3 | M | 059 DONE | TODO |
