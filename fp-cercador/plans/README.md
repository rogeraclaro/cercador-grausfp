...
| 060 | FPO: tercer mode "Cursos FPO (Catalunya)" al cercador (filtres Família→Àrea→Especialitat + comarca→municipi), panell de detall, bloc a la fitxa dels C de pla antic, secció a `fonts.html` | P3 | M–L | 059 DONE | TODO |
